...
final class WithDataHideTest extends TestCase
{
    ...
    {
        $this->assertSame(['data' => null, 'bar' => 'Bar'], $this->response(null, null, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => 'foo', 'bar' => 'Bar'], $this->response('foo', null, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => [], 'bar' => 'Bar'], $this->response([], null, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => 0, 'bar' => 'Bar'], $this->response(0, null, ['bar' => 'Bar'])->getJson());

        $this->assertSame(['data' => null, 'bar' => 'Bar'], $this->response(null, 200, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => 'foo', 'bar' => 'Bar'], $this->response('foo', 200, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => [], 'bar' => 'Bar'], $this->response([], 200, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => 0, 'bar' => 'Bar'], $this->response(0, 200, ['bar' => 'Bar'])->getJson());

        $this->assertSame(['data' => null, 'bar' => 'Bar'], $this->response(null, 300, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => 'foo', 'bar' => 'Bar'], $this->response('foo', 300, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => [], 'bar' => 'Bar'], $this->response([], 300, ['bar' => 'Bar'])->getJson());
        $this->assertSame(['data' => 0, 'bar' => 'Bar'], $this->response(0, 300, ['bar' => 'Bar'])->getJson());
    }
